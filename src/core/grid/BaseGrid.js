...
(function() {
    ...
    Ext.define('Hatimeria.core.grid.BaseGrid', {
         ...
         *        api: {
         *            submit: Actions.Company_Controller.submit,
        ...
        createFormWindow: function(config, record)
        {
            ...
            {
                cfg.submitConfig = {
                    submit: (!isNaN(parseInt(record.getId()))) ? record.proxy.api.update : record.proxy.api.create,
                    text: 'Zapisz',
                    success: function() {
            ...
            if (Ext.Array.contains(this.dockedElements, 'add'))
            {
                items.push({
                    ...
                    items: [{
                        ...
                        scope: this,
                        handler: function() {
                            var record = this.getRecordClass();
